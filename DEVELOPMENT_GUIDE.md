...
- поддерживать совместимость runtime с `PHP 7.4+`.
- проверять изменения хотя бы на `PHP 7.4`, `8.1`, `8.3`.
- не использовать синтаксис PHP 8+, если нет fallback и это ломает PHP 7.4.
